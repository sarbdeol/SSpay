...
router.get("/trial-balance", async (req, res) => {
  try {
    ...
    const txWhere = {
      merchant: { adminId },
      status: "CLEARED",
      ...(startDate || endDate ? { transactionClearTime: dateFilter } : {}), // ← was createdAt
    };
    ...
    // Merchant settled map using per-merchant rate
    ...
    // Agent settled map using per-agent rate
